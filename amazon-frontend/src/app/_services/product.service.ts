...
export class ProductService {
  ...
  public deleteCartItem(cartId){
    return this.httpClient.delete("http://localhost:9090/deleteBasketItem/"+cartId);
   }
  ...
  public getProductDetails(isSingeProductCheckout,productId){
   ...
   public addToCart(productId){
    return this.httpClient.get("http://localhost:9090/addToBasket/"+productId);
   }

   public getCartDetails(){
    return this.httpClient.get("http://localhost:9090/getBasketDetails");
   }
}
